...
/** @type {string} */
const CACHE_VERSION = '1749152743|771901296';
/** @type {string} */
const CACHE_PREFIX = 'HolyTemptation-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'holy_temptation.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["holy_temptation.html","holy_temptation.js","holy_temptation.offline.html","holy_temptation.icon.png","holy_temptation.apple-touch-icon.png","holy_temptation.worker.js","holy_temptation.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["holy_temptation.wasm","holy_temptation.pck"];
